...
@section('content')
    ...
    <div>
        <div class="fade-in">
            <form
                action="/admin/policy-settings/{{ $id }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-md-12" id="req-name">
                                        <div class="form-group">
                                            ...
                                            <input required value="{{ $policy->title }}" name="title" type="text" autocomplete="off" class="form-control" />
                                        </div>
                                        <div class="form-group alert alert-danger hidden">Vui lòng tiêu đề.</div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12" id="req-name">
                                        <div class="form-group">
                                            <label class="frm-label required">* Đường dẫn</label>
                                            <input required value="{{ $policy->href }}" name="href" type="text" autocomplete="off" class="form-control" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group" id="frm-textarea">
                                            <textarea name="content" class="c-tinymce" rows="5">{{ $policy->content }}</textarea>
                                        </div>
                                    </div>
                                </div>
